...
We need maps to represent 

## Point worlds

This uses Cartesian points for all objects, goals, and regions. This is by far the most simple way of modelling a world, as well as for creating behaviours for. The 
...
Any graph-based search algorithm can be applied to the graph generated by the grid to find the shortest between. 
